drop 
  table prereq cascade constraints;
drop 
  table time_slot cascade constraints;
drop 
  table advisor cascade constraints;
drop 
  table takes cascade constraints;
drop 
  table student cascade constraints;
drop 
  table teaches cascade constraints;
drop 
  table section cascade constraints;
drop 
  table instructor cascade constraints;
drop 
  table course cascade constraints;
drop 
  table department cascade constraints;
drop 
  table classroom cascade constraints;
